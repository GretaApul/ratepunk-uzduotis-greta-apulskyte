...
function Steps() {
  return (
    <div className={scss.gridContainer}>
      <img className={scss.logo} src="/assets/Invite Friends Img.svg" alt="" />
      ...
      <img className={scss.logo} src="/assets/Collect coins img.svg" alt="" />

      <img className={scss.logo} src="/assets/Get voucher img.svg" alt="" />
      <div className={scss.textContainer}>
